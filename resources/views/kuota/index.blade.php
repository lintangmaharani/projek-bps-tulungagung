...
<div class="max-w-6xl mx-auto space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 mt-1">Atur kapasitas dan batas periode pendaftaran PKL / Magang BPS.</p>
        </div>
            ...
            <table class="w-full text-left text-xs text-slate-600">
                <thead class="bg-slate-50 border-b border-slate-200 text-slate-700 uppercase font-bold text-[11px]">
                    <tr>
                        ...
                        <th class="py-3.5 px-4 text-center">Pendaftar/Terisi</th>
...
<div id="modal-tambah" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm hidden">
    <div class="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-100 space-y-4">
        <div class="flex items-center justify-between border-b pb-3">
            ...
            <button type="button" onclick="toggleModal('modal-tambah')" class="text-slate-400 hover:text-slate-600 font-bold text-lg">&times;</button>
        </div>
        ...
        <form action="{{ route('admin.kuota.store') }}" method="POST" class="space-y-3 text-xs">
            ...
            <div>
                ...
                <input type="text" name="nama_periode" placeholder="Contoh: Gelombang 1 (Jan-Mar 2026)" required class="w-full px-3.5 py-2 border rounded-xl border-slate-300 focus:ring-2 focus:ring-bpsBlue">
            </div>

            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label class="block font-semibold text-slate-600 mb-1">Tgl Mulai</label>
                ...
                <div>
                    <label class="block font-semibold text-slate-600 mb-1">Tgl Selesai</label>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label class="block font-semibold text-slate-600 mb-1">Jumlah Kuota (Slot)</label>
            ...
            <div>
                ...
                <textarea name="keterangan" rows="2" placeholder="Catatan khusus periode..." class="w-full px-3.5 py-2 border rounded-xl border-slate-300 focus:ring-2 focus:ring-bpsBlue"></textarea>
            </div>
