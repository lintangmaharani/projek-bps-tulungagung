        ...
        <div>
            ...
            <nav class="p-4 space-y-2">
                ...
                @else
                    ...
                    <!-- 5. Jurnal Kegiatan -->
                    <a href="{{ route('jurnal.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition duration-200 text-xs font-medium {{ request()->routeIs('jurnal.*') || request()->routeIs('mahasiswa.jurnal.*') || request()->is('jurnal*') ? 'bg-bpsOrange font-bold text-white shadow-lg shadow-orange-500/30' : 'text-blue-100 hover:bg-white/10' }}">
