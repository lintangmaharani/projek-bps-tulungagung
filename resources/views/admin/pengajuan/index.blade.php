                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($pengajuanList as $index => $item)
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <!-- Foto Pemohon -->
                            <td class="py-4 px-4">
                                @if(isset($item->file_foto) && $item->file_foto)
                                    <img src="{{ asset('storage/' . $item->file_foto) }}" alt="Foto" class="w-10 h-10 rounded-full object-cover border border-slate-200 shadow-sm">
                                @else
